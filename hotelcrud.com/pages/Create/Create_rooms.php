...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $sql_add = "SET IDENTITY_INSERT Distribution ON 
                    insert INTO Room (Room_ID, Floor, Quantity_beds, Quantity_persons, Cost) VALUES ($ID, $Floor, $Quantity_beds, 
                    $Quantity_persons, $Cost)
        ...
        $successMessage = "Номер успешно добавлен";
